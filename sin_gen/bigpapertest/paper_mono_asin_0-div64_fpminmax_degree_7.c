...
// P = fpminimax(asin(x), 7, [|D...|], [1b-53,1/64]);
// 0x363c63e13ed237f2 + x * (0x3ff0000000000000 + x * (0xbcb030e1fdcc7cc9 + x * (0x3fc5555555557ab2 + x * (0xbddc93eb12c03fd1 + x * (0x3fb33333820c6efe + x * (0xbeba2379e7a6f79e + x * 0x3fa6e2a23cd6d8d6))))))
static const DL
C[NUM] = {
	{.l = 0x363c63e13ed237f2},
	{.l = 0x3ff0000000000000},
	{.l = 0xbcb030e1fdcc7cc9},
	{.l = 0x3fc5555555557ab2},
 	{.l = 0xbddc93eb12c03fd1},
	{.l = 0x3fb33333820c6efe},
	{.l = 0xbeba2379e7a6f79e},
	{.l = 0x3fa6e2a23cd6d8d6},
};
