...
// > P = fpminimax(asin(x), 7, [|D...|], [1b-53,1/32]); printexpansion(P);
// 0x36ac744f0bc00f25 + x * (0x3ff0000000000000 + x * (0xbd203a3db806b5fb + x * (0x3fc55555555eb1a0 + x * (0xbe2ca2ac671e00fb + x * (0x3fb33338232116d0 + x * (0xbeea2e9de6ea5b64 + x * 0x3fa6f849fa31a15f))))))
static const DL
C[NUM] = {
	{.l = 0x36ac744f0bc00f25},
	{.l = 0x3ff0000000000000},
	{.l = 0xbd203a3db806b5fb},
	{.l = 0x3fc55555555eb1a0},
 	{.l = 0xbe2ca2ac671e00fb},
	{.l = 0x3fb33338232116d0},
	{.l = 0xbeea2e9de6ea5b64},
	{.l = 0x3fa6f849fa31a15f},
};
