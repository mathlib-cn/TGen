...
{D(0x3fc24924, 0x92492492)}, // 1/7
};
*/
/* coefficients for polynomial approximation of log(1 + x) on [0, 1/128] */
// absoulute is badder than the default way.
// coeffients produced by taylor
static const DL
P[] =
{
	{.l = 0x3ff0000000000000}, // 1
	{.l = 0xbfe0000000000000}, // -0.5
	{.l = 0x3fd5555555555555}, // 1/3
	{.l = 0xbfd0000000000000}, // -1/4
	{.l = 0x3fc999999999999a}, // 1/5
	{.l = 0xbfc5555555555555}, // -1/6
	{.l = 0x3fc2492492492492}, // 1/7
};
...
double log_gen(double x) {
	...
	ix &= (DSIGNMASK & DEXPMASK);	/* mask off sign and exponent
						* bits of x
						*/
	ix |= twop4;	/* set exponent of x to 0x406 */
