...
// P = fpminimax(asin(x), 7, [|D...|], [1b-53,1/8]);
// 0xba306eff8f4669b5 + x * (0x3ff000000000106f + x * (0xbe0829b2099014d4 + x * (0x3fc555560e67a719 + x * (0xbed072916a967862 + x * (0x3fb338a5617a6e73 + x * (0xbf4c19297da9d050 + x * 0x3fa8c0477035d847))))))
static const DL
C[NUM] = {
	{.l = 0xba306eff8f4669b5},
	{.l = 0x3ff000000000106f},
	{.l = 0xbe0829b2099014d4},
	{.l = 0x3fc555560e67a719},
 	{.l = 0xbed072916a967862},
	{.l = 0x3fb338a5617a6e73},
	{.l = 0xbf4c19297da9d050},
	{.l = 0x3fa8c0477035d847},
};
