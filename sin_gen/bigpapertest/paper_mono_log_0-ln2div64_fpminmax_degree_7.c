...
/* coefficients for polynomial approximation of log(1 + t) on [0, 1/64]   */
// P = fpminimax(log(1+x), [|1,2,3,4,5,6|], [|D...|], [1b-53,1/64]);
...
*/
// P = fpminimax(log(1+x), [|1,2,3,4,5,6,7|], [|D...|], [1b-53,1/64]);
