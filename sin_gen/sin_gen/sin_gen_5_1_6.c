...
double sin_gen(double ix) {
	...
	appro_s = 0.0 + iiix * (coefficient[0][1].d + iiix * (coefficient[0][2].d + iiix * (coefficient[0][3].d + iiix * (coefficient[0][4].d + iiix * (coefficient[0][5].d + iiix * (coefficient[0][6].d))))));
	appro_c = 0.0 + iiix * (coefficient[1][1].d + iiix * (coefficient[1][2].d + iiix * (coefficient[1][3].d + iiix * (coefficient[1][4].d + iiix * (coefficient[1][5].d + iiix * (coefficient[1][6].d))))));
