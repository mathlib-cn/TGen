...
static const DL
lg2byHI[BIT] = {
	{.l = 0x3fc3441350000000 }, // 1
	{.l = 0x3fb3441350000000 }, // 2
	{.l = 0x3fa3441350000000 }, // 3
	{.l = 0x3f93441350000000 }, // 4
	{.l = 0x3f83441350000000 }, // 5 ...
	{.l = 0x3f73441350000000 }, // 6
	{.l = 0x3f63441350000000 }, // 7
},
lg2byLO[BIT] = {
	{.l = 0x3df3ef3fde623e25 }, // 1
	{.l = 0x3de3ef3fde623e25 }, // 2
	{.l = 0x3dd3ef3fde623e25 }, // 3
	{.l = 0x3dc3ef3fde623e25 }, // 4 
	{.l = 0x3db3ef3fde623e25 }, // 5 ...
	{.l = 0x3da3ef3fde623e25 }, // 6
	{.l = 0x3d93ef3fde623e25 }, // 7
},
invlg2by[BIT] = {
	{.l = 0x401a934f0979a371 }, // 1
	{.l = 0x402a934f0979a371 }, // 2
	{.l = 0x403a934f0979a371 }, // 3
	{.l = 0x404a934f0979a371 }, // 4
	{.l = 0x405a934f0979a371 }, // 5 ...
	{.l = 0x406a934f0979a371 }, // 6
	{.l = 0x407a934f0979a371 }, // 7
};
...
int gen(struct constraint input_parameter) {
	...
	if ((func = fopen("exp10_gen.c", "w")) == (FILE *)0) {
	...
	*/
	...
	// generate code for exp_gen
	{
		...
		fprintf(func, "lg2by%dHI = { .l = 0x%lx },\n", bitnum, lg2byHI[bit-1].l);
		fprintf(func, "lg2by%dLO = { .l = 0x%lx },\n", bitnum, lg2byLO[bit-1].l);
		fprintf(func, "invlg2by%d = { .l = 0x%lx },\n", bitnum, invlg2by[bit-1].l);
		fprintf(func, "log10 = { .l = 0x40026bb1bbb55516};\n");
		fprintf(func, "\n");
	...
	{
		fprintf(func, "double exp10_gen(double x) {\n");
		fprintf(func, "	double T, r, r1, r2, rr, r_poly, result, r_hi, r_lo;\n");
		fprintf(func, "	long int T_int;\n");
		fprintf(func, "	unsigned long int hi, lo;\n");
		fprintf(func, "\n");
		fprintf(func, "	T = x * invlg2by%d.d;\n", bitnum);
		fprintf(func, "	T_int = T;\n");
	
		if (degree > 1) {
			fprintf(func, "	// 0 <= r <= 1/k1\n");
			fprintf(func, "	r1 = x - T_int * lg2by%dHI.d;\n", bitnum);
			fprintf(func, "	r2 = T_int * lg2by%dLO.d;\n", bitnum);
			fprintf(func, "	r = r1 - r2;\n");
			fprintf(func, "	r = r * log10.d;\n");
			fprintf(func, "\n");
			...
			fprintf(func, "\tr_poly = r * C[1].d + C[0].d;\n\n");
		} 
		else {
